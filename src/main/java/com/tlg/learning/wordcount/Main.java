package com.tlg.learning.wordcount;
...
public final class Main {
  ...
  /**
   * Creates an instance of{@link WordCounter}, using it to process the contents of
   * "The Hound of the Baskervilles" by Author Conan Doyle. After processing,
   * the word counts(excluding short words) are listed in descending order.
   * <p>This method assumes that a text file named{@code hound-of-the-baskervilles.txt}
   * is located on the classpath; otherwise(or if that file cannot be read for some reason)
